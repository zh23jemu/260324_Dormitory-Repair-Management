...
const routes = [
  { path: '/login', name: 'login', component: LoginView },
  {
    ...
    children: [
      ...
      { path: 'forum-posts', name: 'forum-posts', component: () => import('../views/admin/ForumManageView.vue'), meta: { roles: ['admin'] } },
      { path: 'service-messages', name: 'service-messages', component: () => import('../views/admin/ServiceMessageManageView.vue'), meta: { roles: ['admin'] } },
      { path: 'ratings', name: 'ratings', component: () => import('../views/admin/RatingManageView.vue'), meta: { roles: ['admin'] } },
