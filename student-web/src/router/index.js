...
const routes = [
  { path: '/login', name: 'login', component: AuthView },
  {
    ...
    children: [
      ...
      { path: 'announcements', name: 'announcements', component: () => import('../views/student/AnnouncementListView.vue') },
      { path: 'forum', name: 'forum', component: () => import('../views/student/ForumView.vue') },
